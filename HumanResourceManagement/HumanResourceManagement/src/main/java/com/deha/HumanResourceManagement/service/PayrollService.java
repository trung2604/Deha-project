...
public class PayrollService {
    ...
    public List<PayrollResponse> generate(GeneratePayrollRequest request) {
        ...
        for (User user : targets) {
            ...
            int standardWorkHours = user.getOffice().getStandardWorkHours() > 0 ? user.getOffice().getStandardWorkHours() : 9;
            double otWeekdayMultiplier = user.getOffice().getOtWeekdayMultiplier() > 0 ? user.getOffice().getOtWeekdayMultiplier() : 1.5d;
            double otWeekendMultiplier = user.getOffice().getOtWeekendMultiplier() > 0 ? user.getOffice().getOtWeekendMultiplier() : 2.0d;
            double otHolidayMultiplier = user.getOffice().getOtHolidayMultiplier() > 0 ? user.getOffice().getOtHolidayMultiplier() : 3.0d;
            double otNightBonusMultiplier = user.getOffice().getOtNightBonusMultiplier() > 0 ? user.getOffice().getOtNightBonusMultiplier() : 0.3d;
    ...
    public List<PayrollResponse> list(Integer year, Integer month, UUID officeId) {
