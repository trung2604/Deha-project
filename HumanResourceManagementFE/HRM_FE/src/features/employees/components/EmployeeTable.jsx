  ...
  return (
    ...
    >
            ...
            {loading ? (
              ...
              <tr>
                <td colSpan={6} className="px-6 py-16 text-center">
                  <p style={{ color: '#595959', fontSize: '14px' }}>No employees found</p>
                </td>
              </tr>
            ) : (
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div
                        ...
                        style={{ backgroundColor: '#1677FF', fontSize: '13px', fontWeight: '600' }}
                      >
                        {employee.avatar}
                      </div>
                      <div>
                        ...
                        <div style={{ color: '#595959', fontSize: '13px' }}>{employee.email}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <span style={{ color: '#0A0A0A', fontSize: '14px' }}>{employee.department}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span style={{ color: '#595959', fontSize: '14px' }}>{employee.position}</span>
                  </td>
                  <td className="px-6 py-4">
                    <span
                      style={{
      ...
      {!loading && employees.length > 0 && (
        <div className="px-6 py-4 border-t flex items-center justify-end" style={{ borderColor: '#E8E8E8' }}>
